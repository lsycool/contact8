...
public class ResideMenu extends FrameLayout {
    ...
    public void openMenu(int direction) {
        ...
        HomeContactActivity.menuBtn.setBackgroundResource(R.drawable.menu_fold);
    ...
    public void closeMenu() {
        ...
        isOpened = false;
        HomeContactActivity.menuBtn.setBackgroundResource(R.drawable.menu_unfold);
    ...
    private void hideScrollViewMenu(View scrollViewLeftMenu2) {
        if (scrollViewLeftMenu2 != null && scrollViewLeftMenu2.getParent() != null) {
            removeView(scrollViewLeftMenu2);
        }
    }
}
